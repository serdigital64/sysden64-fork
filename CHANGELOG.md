...
- NodeJS: optional NODE_HOME env

### Changed

- FZF: upgraded to v0.74, added legacy support for v0.58
...
- Antigravity: migrated to Antigravity IDE
...
- Modules
  ...
  - Rust
- Bash
  - Load system-wide profile plugins (/etc/profile.d/)
